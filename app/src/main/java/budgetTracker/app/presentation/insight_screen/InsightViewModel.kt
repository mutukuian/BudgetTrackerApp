package budgetTracker.app.presentation.insight_screen

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import budgetTracker.app.domain.model.Transaction
import budgetTracker.app.domain.use_case.read_database.Get14DayTransaction
import budgetTracker.app.domain.use_case.read_database.Get3DayTransaction
import budgetTracker.app.domain.use_case.read_database.Get7DayTransaction
import budgetTracker.app.domain.use_case.read_database.GetLastMonthTransactionUseCase
import budgetTracker.app.domain.use_case.read_database.GetStartOfTheMonthTransactionUseCase
import budgetTracker.app.domain.use_case.read_database.GetTransactionByTypeUseCase
import budgetTracker.app.domain.use_case.read_datastore.GetCurrencyUseCase
import budgetTracker.app.presentation.home_screen.TransactionType
...
class InsightViewModel @Inject constructor(
    ...
    private val getStartOfMonthTransaction:GetStartOfTheMonthTransactionUseCase ,
