...
import budgetTracker.app.presentation.home_screen.components.AddEntryChooser
import budgetTracker.app.presentation.home_screen.components.Header
import budgetTracker.app.presentation.home_screen.components.ListPlaceholder
import budgetTracker.app.presentation.home_screen.components.TabButton
import budgetTracker.app.presentation.home_screen.components.TransactionItem
...
fun HomeScreen(
    ...
    BottomSheetScaffold(
        ...
        Column(
            ...
            AnimatedVisibility(visible = currentTabButton == budgetTracker.app.presentation.home_screen.TabButton.TODAY) {
            ...
            // monthly expenses
            AnimatedVisibility(visible = currentTabButton == budgetTracker.app.presentation.home_screen.TabButton.MONTH) {
